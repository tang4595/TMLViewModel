...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/TMLViewModel/TMLViewModel.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/TNetHttp/TNetHttp.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/TPKeyboardAvoiding/TPKeyboardAvoiding.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/TUtilExt/TUtilExt.framework"
